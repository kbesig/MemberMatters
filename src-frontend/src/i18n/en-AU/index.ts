...
export default {
  ...
  adminTools: {
    ...
    billingGroupMemberCosts: "Billing Group Members' Costs",
    billingGroupName: 'Billing Group',
    memberAddons: 'Add-ons',
    addonName: 'Add-on',
    memberName: 'Member',
    cost: 'Cost',
  ...
  paymentPlans: {
    ...
    subscriptionInfo: 'Subscription Info',
    groupActiveTitle: 'Covered by Billing Group',
    groupActiveDescription:
      'Your membership is covered by a billing group. Your subscription is managed by the group primary member.',
    groupInactiveTitle: 'Billing Group Payment Issue',
    groupInactiveDescription:
      'The primary member of your billing group has a payment issue. Your site access may be affected until the issue is resolved. Please contact the group primary member.',
    upcomingInvoice: 'Upcoming Invoice',
    lineType: {
      main: 'Subscription',
      billing_group_addon: 'Group Add-on',
      addon: 'Add-on',
      proration: 'Proration',
    },
    totalDue: 'Total Due',
  ...
  billingGroup: {
    ...
    deleteGroupConfirm:
      'Are you sure you want to delete this billing group? All members will be removed and their subscriptions cancelled.',
    deleteGroupSuccess: 'Billing group deleted.',
    deleteGroupFailed: 'Failed to delete billing group.',
    leaveGroup: 'Leave Group',
    leaveGroupConfirm:
      'Are you sure you want to leave this billing group? Your membership subscription will become inactive.',
    leaveGroupSuccess: 'You have left the billing group.',
    leaveGroupFailed: 'Failed to leave billing group.',
    inviteMember: 'Invite Member',
    inviteMemberEmail: 'Member Email',
    inviteMemberSent: 'Invitation sent.',
    inviteMemberFailed: 'Failed to send invitation.',
    inviteNonmember: 'Invite Non-Member',
    inviteNonmemberSent: 'Invitation email sent.',
    inviteNonmemberFailed: 'Failed to send invitation.',
    removeMember: 'Remove Member',
    removeMemberConfirm: 'Remove {name} from the billing group?',
    removeMemberSuccess: 'Member removed.',
    removeMemberFailed: 'Failed to remove member.',
    pendingInviteTitle: 'Billing Group Invitation',
    pendingInviteDescription:
      'You have been invited to join {groupName} by {invitedBy}. If you accept, your membership will be covered by the group.',
    ...
    acceptSuccess: 'You have joined the billing group.',
    ...
    manageGroups: 'Manage Billing Groups',
    noGroups: 'No billing groups found.',
    memberCount: 'Members',
  },
  addons: {
    manageAddons: 'Subscription Addons',
    ...
    stripeSynced: 'Stripe Synced',
    createSuccess: 'Addon created successfully.',
    createFailed: 'Failed to create addon.',
    updateSuccess: 'Addon updated.',
    updateFailed: 'Failed to update addon.',
    deleteSuccess: 'Addon deleted.',
    deleteFailed: 'Failed to delete addon.',
    noAddons: 'No addons found.',
    setCurrentAddon: 'Set as Current Additional Member Addon',
    setCurrentSuccess: 'Current addon updated.',
    setCurrentFailed: 'Failed to update current addon.',
    addToSubscription: 'Add to Subscription',
    removeFromSubscription: 'Remove from Subscription',
    addSuccess: 'Addon added to subscription.',
    addFailed: 'Failed to add addon.',
    removeSuccess: 'Addon removed from subscription.',
    removeFailed: 'Failed to remove addon.',
    activeAddons: 'Active Addons',
    availableAddons: 'Available Addons',
    noActiveAddons: 'No active addons on your subscription.',
  ...
  shelfRental: {
    ...
    requestShelf: 'Request Shelf',
    requestSuccess: 'Shelf request submitted.',
    requestFailed: 'Failed to submit shelf request.',
    cancelRequest: 'Cancel Request',
    cancelRequestSuccess: 'Request cancelled.',
    cancelRequestFailed: 'Failed to cancel request.',
    pendingRequests: 'Pending Requests',
    noPendingRequests: 'No pending requests.',
    noShelves: 'You are not currently renting any shelves.',
    shelfNumber: 'Shelf Number',
    status: 'Status',
    startDate: 'Start Date',
    pricing: 'Pricing',
    createShelf: 'Create Shelf',
    createShelfSuccess: 'Shelf created.',
    createShelfFailed: 'Failed to create shelf.',
    assignMember: 'Assign Member',
    assignSuccess: 'Member assigned to shelf.',
    assignFailed: 'Failed to assign member.',
    removeMember: 'Remove Member',
    removeMemberConfirm: 'Remove {name} from shelf {shelf}?',
    removeMemberSuccess: 'Member removed from shelf.',
    removeMemberFailed: 'Failed to remove member from shelf.',
    setNextMember: 'Set Next Occupant',
    setNextSuccess: 'Next occupant set.',
    setNextFailed: 'Failed to set next occupant.',
    currentMember: 'Current Member',
    nextMember: 'Next Occupant',
    noCurrentMember: 'Available',
    noNextMember: 'None',
    stats: 'Statistics',
    total: 'Total',
    occupied: 'Occupied',
    ...
    noRequests: 'No pending requests in queue.',
    quantity: 'Quantity',
    requestedAt: 'Requested',
    memberSearch: 'Search Member',
    notConfigured: 'Shelf rental is not currently available.',
    statusAvailable: 'Available',
    statusOccupied: 'Occupied',
    statusCancelled: 'Cancelling',
  },
};
