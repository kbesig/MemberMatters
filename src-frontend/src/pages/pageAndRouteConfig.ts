  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        to: '/manage/billing-groups',
        name: 'manageBillingGroups',
        loggedIn: true,
        admin: true,
        component: () => import('pages/AdminTools/ManageBillingGroups.vue'),
      },
      {
        icon: icons.plans,
        to: '/manage/addons',
        ...
        loggedIn: true,
        admin: true,
        component: () => import('pages/AdminTools/ManageAddons.vue'),
      },
      {
        icon: icons.tools,
        to: '/manage/shelves',
