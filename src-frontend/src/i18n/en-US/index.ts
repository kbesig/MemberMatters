export default {
  ...
  adminTools: {
    ...
    billingGroupNameRequired: 'Billing group name is required',
    ...
    cancelBillingGroupInvite: 'Cancel Billing Group Invite',
    memberAddedToBillingGroup: 'Member added to billing group',
    memberRemovedFromBillingGroup: 'Member removed from billing group',
    memberInvitedToBillingGroup: 'Member invited to billing group',
    billingGroupInviteCancelled: 'Billing group invite cancelled',
    noBillingGroup: 'No billing group',
